...
This test code shows how to perform system-wide behavioral analysis of the program using [Percepio Tracealyzer tool](https://www.segger.com/products/development-tools/systemview/).
