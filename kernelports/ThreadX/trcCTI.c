...
/* External declarations */
extern UINT _tx_block_allocate_orig(TX_BLOCK_POOL *pool_ptr, VOID **block_ptr, ULONG wait_option);
extern UINT _tx_block_pool_create_orig(TX_BLOCK_POOL *pool_ptr, CHAR *name_ptr, ULONG block_size, VOID *pool_start, ULONG pool_size);
extern UINT _tx_block_pool_delete_orig(TX_BLOCK_POOL *pool_ptr);
extern UINT _tx_block_pool_info_get_orig(TX_BLOCK_POOL *pool_ptr, CHAR **name, ULONG *available_blocks, ULONG *total_blocks, TX_THREAD **first_suspended, ULONG *suspended_count, TX_BLOCK_POOL **next_pool);
extern UINT _tx_block_pool_performance_info_get_orig(TX_BLOCK_POOL *pool_ptr, ULONG *allocates, ULONG *releases, ULONG *suspensions, ULONG *timeouts);
extern UINT _tx_block_pool_performance_system_info_get_oirg(ULONG *allocates, ULONG *releases, ULONG *suspensions, ULONG *timeouts);
extern UINT _tx_block_pool_prioritize_orig(TX_BLOCK_POOL *pool_ptr);
extern UINT _tx_block_release_orig(VOID *block_ptr);

extern UINT _tx_byte_allocate_orig(TX_BYTE_POOL *pool_ptr, VOID **memory_ptr, ULONG memory_size,  ULONG wait_option);
extern UINT _tx_byte_pool_create_orig(TX_BYTE_POOL *pool_ptr, CHAR *name_ptr, VOID *pool_start, ULONG pool_size);
extern UINT _tx_byte_pool_delete_orig(TX_BYTE_POOL *pool_ptr);
extern UINT _tx_byte_pool_info_get_orig(TX_BYTE_POOL *pool_ptr, CHAR **name, ULONG *available_bytes, ULONG *fragments, TX_THREAD **first_suspended, ULONG *suspended_count, TX_BYTE_POOL **next_pool);
extern UINT _tx_byte_pool_performance_info_get_orig(TX_BYTE_POOL *pool_ptr, ULONG *allocates, ULONG *releases, ULONG *fragments_searched, ULONG *merges, ULONG *splits, ULONG *suspensions, ULONG *timeouts);
extern UINT _tx_byte_pool_performance_system_info_get_orig(ULONG *allocates, ULONG *releases, ULONG *fragments_searched, ULONG *merges,	ULONG *splits, ULONG *suspensions,ULONG *timeouts);
extern UINT _tx_byte_pool_prioritize_orig(TX_BYTE_POOL *pool_ptr);
extern UINT _tx_byte_release_orig(VOID *memory_ptr);

extern UINT _tx_event_flags_create_orig(TX_EVENT_FLAGS_GROUP *group_ptr, CHAR *name_ptr);
extern UINT _tx_event_flags_delete_orig(TX_EVENT_FLAGS_GROUP *group_ptr);
extern UINT _tx_event_flags_get_orig(TX_EVENT_FLAGS_GROUP *group_ptr, ULONG requested_flags, UINT get_option, ULONG *actual_flags_ptr, ULONG wait_option);
extern UINT _tx_event_flags_info_get_orig(TX_EVENT_FLAGS_GROUP *group_ptr, CHAR **name, ULONG *current_flags, TX_THREAD **first_suspended, ULONG *suspended_count, TX_EVENT_FLAGS_GROUP **next_group);
extern UINT _tx_event_flags_performance_info_get_orig(TX_EVENT_FLAGS_GROUP *group_ptr, ULONG *sets, ULONG *gets, ULONG *suspensions, ULONG *timeouts);
extern UINT _tx_event_flags_performance_system_info_get_orig(ULONG *sets, ULONG *gets, ULONG *suspensions, ULONG *timeouts);
extern UINT _tx_event_flags_set_orig(TX_EVENT_FLAGS_GROUP *group_ptr, ULONG flags_to_set, UINT set_option);
extern UINT _tx_event_flags_set_notify_orig(TX_EVENT_FLAGS_GROUP *group_ptr, VOID (*events_set_notify)(TX_EVENT_FLAGS_GROUP *notify_group_ptr));

extern UINT _tx_mutex_create_orig(TX_MUTEX *mutex_ptr, CHAR *name_ptr, UINT inherit);
extern UINT _tx_mutex_delete_orig(TX_MUTEX *mutex_ptr);
extern UINT _tx_mutex_get_orig(TX_MUTEX *mutex_ptr, ULONG wait_option);
extern UINT _tx_mutex_info_get_orig(TX_MUTEX *mutex_ptr, CHAR **name, ULONG *count, TX_THREAD **owner, TX_THREAD **first_suspended, ULONG *suspended_count, TX_MUTEX **next_mutex);
extern UINT _tx_mutex_performance_info_get_orig(TX_MUTEX *mutex_ptr, ULONG *puts, ULONG *gets, ULONG *suspensions, ULONG *timeouts, ULONG *inversions, ULONG *inheritances);
extern UINT _tx_mutex_performance_system_info_get_oirg(ULONG *puts, ULONG *gets, ULONG *suspensions, ULONG *timeouts, ULONG *inversions, ULONG *inheritances);
extern UINT _tx_mutex_prioritize_orig(TX_MUTEX *mutex_ptr);
extern UINT _tx_mutex_put_orig(TX_MUTEX *mutex_ptr);

extern UINT _tx_queue_create_orig(TX_QUEUE *queue_ptr, CHAR *name_ptr, UINT message_size, VOID *queue_start, ULONG queue_size);
extern UINT _tx_queue_delete_orig(TX_QUEUE *queue_ptr);
extern UINT _tx_queue_flush_orig(TX_QUEUE *queue_ptr);
extern UINT _tx_queue_front_send_orig(TX_QUEUE *queue_ptr, VOID *source_ptr, ULONG wait_option);
extern UINT _tx_queue_info_get_orig(TX_QUEUE *queue_ptr, CHAR **name, ULONG *enqueued, ULONG *available_storage, TX_THREAD **first_suspended, ULONG *suspended_count, TX_QUEUE **next_queue);
extern UINT _tx_queue_performance_info_get_orig(TX_QUEUE *queue_ptr, ULONG *messages_sent, ULONG *messages_received, ULONG *empty_suspensions, ULONG *full_suspensions, ULONG *full_errors, ULONG *timeouts);
extern UINT _tx_queue_performance_system_info_get_orig(ULONG *messages_sent, ULONG *messages_received, ULONG *empty_suspensions, ULONG *full_suspensions, ULONG *full_errors, ULONG *timeouts);
extern UINT _tx_queue_prioritize_orig(TX_QUEUE *queue_ptr);
extern UINT _tx_queue_receive_orig(TX_QUEUE *queue_ptr, VOID *destination_ptr, ULONG wait_option);
extern UINT _tx_queue_send_notify_orig(TX_QUEUE *queue_ptr, VOID (*queue_send_notify)(TX_QUEUE *notify_queue_ptr));
extern UINT _tx_queue_send_orig(TX_QUEUE *queue_ptr, VOID *source_ptr, ULONG wait_option);

extern UINT _tx_semaphore_ceiling_put_orig(TX_SEMAPHORE *semaphore_ptr, ULONG ceiling);
extern UINT _tx_semaphore_create_orig(TX_SEMAPHORE *semaphore_ptr, CHAR *name_ptr, ULONG initial_count);
extern UINT _tx_semaphore_delete_orig(TX_SEMAPHORE *semaphore_ptr);
extern UINT _tx_semaphore_get_orig(TX_SEMAPHORE *semaphore_ptr, ULONG wait_option);
extern UINT _tx_semaphore_info_get_orig(TX_SEMAPHORE *semaphore_ptr, CHAR **name, ULONG *current_value, TX_THREAD **first_suspended, ULONG *suspended_count, TX_SEMAPHORE **next_semaphore);
extern UINT _tx_semaphore_performance_info_get_orig(TX_SEMAPHORE *semaphore_ptr, ULONG *puts, ULONG *gets, ULONG *suspensions, ULONG *timeouts);
extern UINT _tx_semaphore_performance_system_info_get_oirg(ULONG *puts, ULONG *gets, ULONG *suspensions, ULONG *timeouts);
extern UINT _tx_semaphore_prioritize_orig(TX_SEMAPHORE *semaphore_ptr);
extern UINT _tx_semaphore_put_notify_orig(TX_SEMAPHORE *semaphore_ptr, VOID (*semaphore_put_notify)(TX_SEMAPHORE *notify_semaphore_ptr));
extern UINT _tx_semaphore_put_orig(TX_SEMAPHORE *semaphore_ptr);

extern UINT _tx_thread_create_orig(TX_THREAD *thread_ptr, CHAR *name_ptr, VOID (*entry_function)(ULONG id), ULONG entry_input, VOID *stack_start, ULONG stack_size, UINT priority, UINT preempt_threshold, ULONG time_slice, UINT auto_start);
extern UINT _tx_thread_delete_orig(TX_THREAD *thread_ptr);
extern UINT _tx_thread_entry_exit_notify_orig(TX_THREAD *thread_ptr, VOID (*thread_entry_exit_notify)(TX_THREAD *notify_thread_ptr, UINT type));
extern UINT _tx_thread_info_get_orig(TX_THREAD *thread_ptr, CHAR **name, UINT *state, ULONG *run_count, UINT *priority, UINT *preemption_threshold, ULONG *time_slice, TX_THREAD **next_thread, TX_THREAD **next_suspended_thread);
extern UINT _tx_thread_performance_info_get_orig(TX_THREAD *thread_ptr, ULONG *resumptions, ULONG *suspensions, ULONG *solicited_preemptions, ULONG *interrupt_preemptions, ULONG *priority_inversions, ULONG *time_slices, ULONG *relinquishes, ULONG *timeouts, ULONG *wait_aborts, TX_THREAD **last_preempted_by);
extern UINT _tx_thread_performance_system_info_get_oirg(ULONG *resumptions, ULONG *suspensions, ULONG *solicited_preemptions, ULONG *interrupt_preemptions, ULONG *priority_inversions, ULONG *time_slices, ULONG *relinquishes, ULONG *timeouts, ULONG *wait_aborts, ULONG *non_idle_returns, ULONG *idle_returns);
extern UINT _tx_thread_preemption_change_orig(TX_THREAD *thread_ptr, UINT new_threshold, UINT *old_threshold);
extern UINT _tx_thread_priority_change_orig(TX_THREAD *thread_ptr, UINT new_priority, UINT *old_priority);
extern UINT _tx_thread_reset_orig(TX_THREAD *thread_ptr);
extern UINT _tx_thread_resume_orig(TX_THREAD *thread_ptr);
extern UINT _tx_thread_sleep_orig(ULONG timer_ticks);
extern UINT _tx_thread_stack_error_notify_orig(VOID (*stack_error_handler)(TX_THREAD *thread_ptr));
extern UINT _tx_thread_suspend_orig(TX_THREAD *thread_ptr);
extern UINT _tx_thread_terminate_orig(TX_THREAD *thread_ptr);
extern VOID _tx_thread_time_slice_orig(VOID);
extern UINT _tx_thread_time_slice_change_orig(TX_THREAD *thread_ptr, ULONG new_time_slice, ULONG *old_time_slice);
extern UINT _tx_thread_wait_abort_orig(TX_THREAD  *thread_ptr);

extern ULONG _tx_time_get_orig(VOID);
extern VOID _tx_time_set_orig(ULONG new_time);
extern UINT _tx_timer_activate_orig(TX_TIMER *timer_ptr);
extern UINT _tx_timer_change_orig(TX_TIMER *timer_ptr, ULONG initial_ticks, ULONG reschedule_ticks);
extern UINT _tx_timer_create_orig(TX_TIMER *timer_ptr, CHAR *name_ptr, VOID (*expiration_function)(ULONG id), ULONG expiration_input, ULONG initial_ticks, ULONG reschedule_ticks, UINT auto_activate);
extern UINT _tx_timer_deactivate_orig(TX_TIMER *timer_ptr);
extern UINT _tx_timer_delete_orig(TX_TIMER *timer_ptr);
extern UINT _tx_timer_info_get_orig(TX_TIMER *timer_ptr, CHAR **name, UINT *active, ULONG *remaining_ticks, ULONG *reschedule_ticks, TX_TIMER **next_timer);
extern UINT _tx_timer_performance_info_get_orig(TX_TIMER *timer_ptr, ULONG *activates, ULONG *reactivates, ULONG *deactivates, ULONG *expirations, ULONG *expiration_adjusts);
...
{
	UINT ret = _tx_block_allocate_orig(pool_ptr, block_ptr, wait_option);
...
{
	UINT ret = _tx_block_pool_create_orig(pool_ptr, name_ptr, block_size, pool_start, pool_size);
...
{
	UINT ret = _tx_block_pool_delete_orig(pool_ptr);
...
{
	UINT ret = _tx_block_pool_info_get_orig(pool_ptr, name, available_blocks, total_blocks, first_suspended, suspended_count, next_pool);
...
{
	UINT ret = _tx_block_pool_prioritize_orig(pool_ptr);
...
{
	UINT ret = _tx_block_release_orig(block_ptr);
...
UINT _tx_byte_allocate(TX_BYTE_POOL *pool_ptr, VOID **memory_ptr, ULONG memory_size,  ULONG wait_option)
{
	...
	UINT ret = _tx_byte_allocate_orig(pool_ptr, memory_ptr, memory_size, wait_option);
...
{
	UINT ret = _tx_byte_pool_create_orig(pool_ptr, name_ptr, pool_start, pool_size);
...
{
	UINT ret = _tx_byte_pool_delete_orig(pool_ptr);
...
{
	UINT ret = _tx_byte_pool_info_get_orig(pool_ptr, name, available_bytes, fragments, first_suspended, suspended_count, next_pool);
...
{
	UINT ret = _tx_byte_pool_prioritize_orig(pool_ptr);
...
{
	UINT ret = _tx_byte_release_orig(memory_ptr);
...
{
	UINT ret = _tx_event_flags_create_orig(group_ptr, name_ptr);
...
{
	UINT ret = _tx_event_flags_delete_orig(group_ptr);
...
{
	UINT ret = _tx_event_flags_get_orig(group_ptr, requested_flags, get_option, actual_flags_ptr, wait_option);
...
{
	UINT ret = _tx_event_flags_info_get_orig(group_ptr, name, current_flags, first_suspended, suspended_count, next_group);
...
{
	UINT ret = _tx_event_flags_set_orig(group_ptr, flags_to_set, set_option);
...
{
	UINT ret = _tx_event_flags_set_notify_orig(group_ptr, events_set_notify);
...
{
	UINT ret = _tx_mutex_create_orig(mutex_ptr, name_ptr, inherit);
...
{
	UINT ret = _tx_mutex_delete_orig(mutex_ptr);
...
UINT _tx_mutex_get(TX_MUTEX *mutex_ptr, ULONG wait_option)
{
	...
	UINT ret = _tx_mutex_get_orig(mutex_ptr, wait_option);
...
UINT _tx_mutex_info_get(TX_MUTEX *mutex_ptr, CHAR **name, ULONG *count,
		TX_THREAD **owner, TX_THREAD **first_suspended, ULONG *suspended_count, TX_MUTEX **next_mutex)
{
	UINT ret = _tx_mutex_info_get_orig(mutex_ptr, name, count, owner,
			first_suspended, suspended_count, next_mutex);
...
{
	UINT ret = _tx_mutex_prioritize_orig(mutex_ptr);
...
{
	UINT ret = _tx_mutex_put_orig(mutex_ptr);
...
{
	UINT ret = _tx_queue_create_orig(queue_ptr, name_ptr, message_size, queue_start, queue_size);
...
{
	UINT ret = _tx_queue_delete_orig(queue_ptr);
...
{
	UINT ret = _tx_queue_flush_orig(queue_ptr);
...
UINT _tx_queue_front_send(TX_QUEUE *queue_ptr, VOID *source_ptr, ULONG wait_option)
{
	...
	UINT ret = _tx_queue_front_send_orig(queue_ptr, source_ptr, wait_option);
...
{
	UINT ret = _tx_queue_info_get_orig(queue_ptr, name, enqueued, available_storage, first_suspended, suspended_count, next_queue);
...
{
	UINT ret = _tx_queue_prioritize_orig(queue_ptr);
...
UINT _tx_queue_receive(TX_QUEUE *queue_ptr, VOID *destination_ptr, ULONG wait_option)
{
	...
	UINT ret = _tx_queue_receive_orig(queue_ptr, destination_ptr, wait_option);
...
{
	UINT ret = _tx_queue_send_notify_orig(queue_ptr, queue_send_notify);
...
UINT _tx_queue_send(TX_QUEUE *queue_ptr, VOID *source_ptr, ULONG wait_option)
{
	...
	UINT ret = _tx_queue_send_orig(queue_ptr, source_ptr, wait_option);
...
UINT _tx_semaphore_ceiling_put(TX_SEMAPHORE *semaphore_ptr, ULONG ceiling)
{
	...
	UINT ret = _tx_semaphore_ceiling_put_orig(semaphore_ptr, ceiling);
...
{
	UINT ret = _tx_semaphore_create_orig(semaphore_ptr, name_ptr, initial_count);
...
{
	UINT ret = _tx_semaphore_delete_orig(semaphore_ptr);
...
UINT _tx_semaphore_get(TX_SEMAPHORE *semaphore_ptr, ULONG wait_option)
{
	...
	UINT ret = _tx_semaphore_get_orig(semaphore_ptr, wait_option);
...
{
	UINT ret = _tx_semaphore_info_get_orig(semaphore_ptr, name, current_value, first_suspended, suspended_count, next_semaphore);
...
{
	UINT ret = _tx_semaphore_prioritize_orig(semaphore_ptr);
...
{
	UINT ret = _tx_semaphore_put_notify_orig(semaphore_ptr, semaphore_put_notify);
...
{
	UINT ret = _tx_semaphore_put_orig(semaphore_ptr);
...
{
	UINT ret = _tx_timer_activate_orig(timer_ptr);
...
{
	UINT ret = _tx_timer_change_orig(timer_ptr, initial_ticks, reschedule_ticks);
...
{
	UINT ret = _tx_timer_create_orig(timer_ptr, name_ptr, expiration_function, expiration_input, initial_ticks,
...
{
	UINT ret = _tx_timer_deactivate_orig(timer_ptr);
...
{
	UINT ret = _tx_timer_delete_orig(timer_ptr);
...
{
	UINT ret = _tx_timer_info_get_orig(timer_ptr, name, active, remaining_ticks, reschedule_ticks, next_timer);
...
{
	UINT ret = _tx_thread_create_orig(thread_ptr, name_ptr, entry_function, entry_input, stack_start,
...
{
	UINT ret = _tx_thread_delete_orig(thread_ptr);
...
{
	UINT ret = _tx_thread_entry_exit_notify_orig(thread_ptr, thread_entry_exit_notify);
...
{
	UINT ret = _tx_thread_info_get_orig(thread_ptr, name, state, run_count, priority, preemption_threshold, time_slice, next_thread, next_suspended_thread);
...
{
	UINT ret = _tx_thread_preemption_change_orig(thread_ptr, new_threshold, old_threshold);
...
{
	UINT ret = _tx_thread_priority_change_orig(thread_ptr, new_priority, old_priority);
...
{
	UINT ret = _tx_thread_reset_orig(thread_ptr);
...
{
	UINT ret = _tx_thread_resume_orig(thread_ptr);
...
{
	UINT ret = _tx_thread_suspend_orig(thread_ptr);
...
{
	UINT ret = _tx_thread_terminate_orig(thread_ptr);
...
{
	UINT ret = _tx_thread_time_slice_change_orig(thread_ptr, new_time_slice, old_time_slice);
...
{
	UINT ret = _tx_thread_wait_abort_orig(thread_ptr);
