 ...
 ******************************************************************************/
#define TRC_CFG_RTT_BUFFER_SIZE_UP CONFIG_PERCEPIO_RECORDER_TRC_CFG_RTT_BUFFER_SIZE_UP
 ...
 * in runtime and therefore hard-coded to use the defines in SEGGER_RTT_Conf.h.
 ******************************************************************************/
#define TRC_CFG_RTT_BUFFER_SIZE_DOWN CONFIG_PERCEPIO_RECORDER_TRC_CFG_RTT_BUFFER_SIZE_DOWN
 ...
 ******************************************************************************/
#define TRC_CFG_RTT_UP_BUFFER_INDEX CONFIG_PERCEPIO_RECORDER_TRC_CFG_RTT_UP_BUFFER_INDEX
 ...
 * If you prefer to use buffer 0, it must be configured in SEGGER_RTT_Conf.h. 
 ******************************************************************************/
#define TRC_CFG_RTT_DOWN_BUFFER_INDEX CONFIG_PERCEPIO_RECORDER_TRC_CFG_RTT_DOWN_BUFFER_INDEX
